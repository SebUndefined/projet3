...
//Manager Comments
$app->get('/manager/comment/', "BlogWriter\Controller\AdminController::indexCommentAction")
->bind('manager_comment');
$app->match('/comment/{idParent}/{idArticle}/add/', "BlogWriter\Controller\HomeController::addCommentAction")
->bind('comment_add');
$app->get('/manager/comment/{commentId}/delete/', "BlogWriter\Controller\AdminController::deleteCommentAction")
...
$app->get('/manager/reporting/{id}/{commentId}/delete/', "BlogWriter\Controller\AdminController::deleteReportingAction")
...
//Manager User
$app->get('/manager/user/', "BlogWriter\Controller\AdminController::adminUserAction")
->bind('manager_user');
...
$app->get('/manager/user/{id}/delete/', "BlogWriter\Controller\AdminController::deleteUserAction")
->bind('manager_user_delete');
